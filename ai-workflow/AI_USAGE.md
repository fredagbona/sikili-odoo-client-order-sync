...
* commit strategy
* AI workflow rules
* **`.cursor/rules.md`** — Cursor project rules for this repo; **written and edited by me** (the repository author), not generated by an AI. I use it to steer tooling and assistants while keeping engineering decisions mine.
